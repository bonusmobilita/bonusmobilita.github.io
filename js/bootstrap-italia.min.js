...
!(function (t, e) {
    ...
    var s = "alert",
        ...
        r = "." + o,
        c = f.fn[s],
        h = { CLOSE: "close" + r, CLOSED: "closed" + r, CLICK_DATA_API: "click" + r + ".data-api" },
        u = "alert",
        p = "fade",
        g = "show",
        v = (function () {
            ...
            return (
                ...
                (t._getRootElement = function (t) {
                    var e = m.getSelectorFromElement(t),
                        i = !1;
                    return e && (i = document.querySelector(e)), (i = i || f(t).closest("." + u)[0]);
                }),
                ...
                (t._removeElement = function (e) {
                    var i = this;
                    if ((f(e).removeClass(g), f(e).hasClass(p))) {
    ...
    f(document).on(h.CLICK_DATA_API, '[data-dismiss="alert"]', v._handleDismiss(new v())),
        (f.fn[s] = v._jQueryInterface),
        (f.fn[s].Constructor = v),
        (f.fn[s].noConflict = function () {
            return (f.fn[s] = c), v._jQueryInterface;
        });
    var b = "button",
        y = "bs.button",
        _ = "." + y,
        ...
        D = ".active",
        A = ".btn",
        S = { CLICK_DATA_API: "click" + _ + w, FOCUS_BLUR_DATA_API: "focus" + _ + w + " blur" + _ + w },
        L = (function () {
            function i(t) {
                this._element = t;
            }
            ...
            return (
                (t.toggle = function () {
                    var t = !0,
                        e = !0,
                        i = f(this._element).closest(I)[0];
                    if (i) {
                        var n = this._element.querySelector(T);
                        if (n) {
                            if ("radio" === n.type)
                                if (n.checked && this._element.classList.contains(k)) t = !1;
                                else {
                            ...
                            if (t) {
                                ...
                                (n.checked = !this._element.classList.contains(k)), f(n).trigger("change");
                            }
                            n.focus(), (e = !1);
                        }
                    }
    ...
    f(document)
        .on(S.CLICK_DATA_API, x, function (t) {
            t.preventDefault();
            var e = t.target;
            f(e).hasClass($) || (e = f(e).closest(A)), L._jQueryInterface.call(f(e), "toggle");
        })
        .on(S.FOCUS_BLUR_DATA_API, x, function (t) {
            var e = f(t.target).closest(A)[0];
            f(e).toggleClass(E, /^focus(in)?$/.test(t.type));
        }),
        (f.fn[b] = L._jQueryInterface),
        (f.fn[b].Constructor = L),
        (f.fn[b].noConflict = function () {
            return (f.fn[b] = C), L._jQueryInterface;
        });
    var O = "carousel",
        P = "bs.carousel",
        M = "." + P,
        ...
        z = {
            ...
            LOAD_DATA_API: "load" + M + N,
            CLICK_DATA_API: "click" + M + N,
        },
        Y = "carousel",
        q = "active",
        K = "slide",
        ...
        lt = (function () {
            function o(t, e) {
                (this._items = null),
                    ...
                    (this._element = t),
                    (this._indicatorsElement = this._element.querySelector(st)),
            ...
            return (
                ...
                (t._getConfig = function (t) {
                    return (t = l({}, B, t)), m.typeCheckConfig(O, t, F), t;
                }),
                ...
                (t._addTouchEventListeners = function () {
                    ...
                    if (this._touchSupported) {
                        var i = function (t) {
                                e._pointerEvent && rt[t.originalEvent.pointerType.toUpperCase()] ? (e.touchStartX = t.originalEvent.clientX) : e._pointerEvent || (e.touchStartX = t.originalEvent.touches[0].clientX);
                            },
                            n = function (t) {
                                e._pointerEvent && rt[t.originalEvent.pointerType.toUpperCase()] && (e.touchDeltaX = t.originalEvent.clientX - e.touchStartX),
                                    e._handleSwipe(),
                        ...
                        f(this._element.querySelectorAll(it)).on(z.DRAG_START, function (t) {
                ...
                (t._getItemByDirection = function (t, e) {
                    ...
                    var a = (s + (t === R ? -1 : 1)) % this._items.length;
                    return -1 == a ? this._items[this._items.length - 1] : this._items[a];
                }),
                (t._triggerSlideEvent = function (t, e) {
                    var i = this._getItemIndex(t),
                        n = this._getItemIndex(this._element.querySelector(tt)),
                        s = f.Event(z.SLIDE, { relatedTarget: t, direction: e, from: n, to: i });
                ...
                (t._slide = function (t, e) {
                    var i,
                        ...
                        s,
                        o = this,
                        a = this._element.querySelector(tt),
                        r = this._getItemIndex(a),
                        l = e || (a && this._getItemByDirection(t, a)),
                        c = this._getItemIndex(l),
                        h = Boolean(this._interval);
                    if (((s = t === H ? ((i = V), (n = Q), W) : ((i = G), (n = X), j)), l && f(l).hasClass(q))) this._isSliding = !1;
                    else if (!this._triggerSlideEvent(l, s).isDefaultPrevented() && a && l) {
                        (this._isSliding = !0), h && this.pause(), this._setActiveIndicatorElement(l);
                        var d = f.Event(z.SLID, { relatedTarget: l, direction: s, from: r, to: c });
                        if (f(this._element).hasClass(K)) {
                        ...
                        } else f(a).removeClass(q), f(l).addClass(q), (this._isSliding = !1), f(this._element).trigger(d);
                        h && this.cycle();
                    }
                }),
                (o._jQueryInterface = function (n) {
                    return this.each(function () {
                        ...
                        if ((t || ((t = new o(this, e)), f(this).data(P, t)), "number" == typeof n)) t.to(n);
                ...
                (o._dataApiClickHandler = function (t) {
                    ...
                    if (e) {
                        ...
                        if (i && f(i).hasClass(Y)) {
                            ...
                            s && (n.interval = !1), o._jQueryInterface.call(f(i), n), s && f(i).data(P).to(s), t.preventDefault();
                        }
                    }
                }),
                a(o, null, [
    ...
    f(document).on(z.CLICK_DATA_API, ot, lt._dataApiClickHandler),
        ...
        (f.fn[O] = lt._jQueryInterface),
        (f.fn[O].Constructor = lt),
        (f.fn[O].noConflict = function () {
            return (f.fn[O] = U), lt._jQueryInterface;
        });
    var ct = "collapse",
        ht = "bs.collapse",
        dt = "." + ht,
        ...
        mt = { SHOW: "show" + dt, SHOWN: "shown" + dt, HIDE: "hide" + dt, HIDDEN: "hidden" + dt, CLICK_DATA_API: "click" + dt + ".data-api" },
        gt = "show",
        vt = "collapse",
        bt = "collapsing",
        yt = "collapsed",
        ...
        $t = (function () {
            function r(e, t) {
                ...
                for (var i = [].slice.call(document.querySelectorAll(kt)), n = 0, s = i.length; n < s; n++) {
                    var o = i[n],
            ...
            return (
                ...
                (t.show = function () {
                    ...
                    if (
                        ...
                        !f(this._element).hasClass(gt) &&
                        (this._parent &&
                            0 ===
                                (t = [].slice.call(this._parent.querySelectorAll(Ct)).filter(function (t) {
                                    return "string" == typeof i._config.parent ? t.getAttribute("data-parent") === i._config.parent : t.classList.contains(vt);
                                })).length &&
                            (t = null),
                        !(t && (e = f(t).not(this._selector).data(ht)) && e._isTransitioning))
                    ) {
                        var n = f.Event(mt.SHOW);
                        if ((f(this._element).trigger(n), !n.isDefaultPrevented())) {
                            t && (r._jQueryInterface.call(f(t).not(this._selector), "hide"), e || f(t).data(ht, null));
                            var s = this._getDimension();
                            f(this._element).removeClass(vt).addClass(bt), (this._element.style[s] = 0), this._triggerArray.length && f(this._triggerArray).removeClass(yt).attr("aria-expanded", !0), this.setTransitioning(!0);
                            var o = "scroll" + (s[0].toUpperCase() + s.slice(1)),
                                a = m.getTransitionDurationFromElement(this._element);
                            f(this._element)
                                .one(m.TRANSITION_END, function () {
                                    f(i._element).removeClass(bt).addClass(vt).addClass(gt), (i._element.style[s] = ""), i.setTransitioning(!1), f(i._element).trigger(mt.SHOWN);
                                })
                ...
                (t.hide = function () {
                    ...
                    if (!this._isTransitioning && f(this._element).hasClass(gt)) {
                        var e = f.Event(mt.HIDE);
                        if ((f(this._element).trigger(e), !e.isDefaultPrevented())) {
                            var i = this._getDimension();
                            (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px"), m.reflow(this._element), f(this._element).addClass(bt).removeClass(vt).removeClass(gt);
                            var n = this._triggerArray.length;
                            if (0 < n)
                                for (var s = 0; s < n; s++) {
                                    var o = this._triggerArray[s],
                                        a = m.getSelectorFromElement(o);
                                    if (null !== a) f([].slice.call(document.querySelectorAll(a))).hasClass(gt) || f(o).addClass(yt).attr("aria-expanded", !1);
                                }
                            ...
                            f(this._element)
                                .one(m.TRANSITION_END, function () {
                                    t.setTransitioning(!1), f(t._element).removeClass(bt).addClass(vt).trigger(mt.HIDDEN);
                                })
                ...
                (t._getConfig = function (t) {
                    return ((t = l({}, pt, t)).toggle = Boolean(t.toggle)), m.typeCheckConfig(ct, t, ft), t;
                }),
                (t._getDimension = function () {
                    return f(this._element).hasClass(_t) ? _t : wt;
                }),
                ...
                (r._jQueryInterface = function (n) {
                    return this.each(function () {
                        var t = f(this),
                            e = t.data(ht),
                            i = l({}, pt, t.data(), "object" == typeof n && n ? n : {});
                        if ((!e && i.toggle && /show|hide/.test(n) && (i.toggle = !1), e || ((e = new r(this, i)), t.data(ht, e)), "string" == typeof n)) {
    ...
    f(document).on(mt.CLICK_DATA_API, kt, function (t) {
        ...
        f(n).each(function () {
            var t = f(this),
                e = t.data(ht) ? "toggle" : i.data();
            $t._jQueryInterface.call(t, e);
        });
    }),
        (f.fn[ct] = $t._jQueryInterface),
        (f.fn[ct].Constructor = $t),
        (f.fn[ct].noConflict = function () {
            return (f.fn[ct] = ut), $t._jQueryInterface;
        });
    var Et = "dropdown",
        xt = "bs.dropdown",
        It = "." + xt,
        ...
        St = { HIDE: "hide" + It, HIDDEN: "hidden" + It, SHOW: "show" + It, SHOWN: "shown" + It, CLICK: "click" + It, CLICK_DATA_API: "click" + It + Tt, KEYDOWN_DATA_API: "keydown" + It + Tt, KEYUP_DATA_API: "keyup" + It + Tt },
        Lt = "disabled",
        Ot = "show",
        Pt = "dropup",
        Mt = "dropright",
        ...
        Gt = "right-start",
        Vt = "left-start",
        Qt = { offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic" },
        Xt = { offset: "(number|string|function)", flip: "boolean", boundary: "(string|element)", reference: "(string|element)", display: "string" },
        Jt = (function () {
            function c(t, e) {
            ...
            return (
                (t.toggle = function () {
                    if (!this._element.disabled && !f(this._element).hasClass(Lt)) {
                        var t = c._getParentFromElement(this._element),
                            e = f(this._menu).hasClass(Ot);
                        if ((c._clearMenus(), !e)) {
                            ...
                            if ((f(t).trigger(n), !n.isDefaultPrevented())) {
                                if (!this._inNavbar) {
                                    ...
                                    var s = this._element;
                                    "parent" === this._config.reference ? (s = t) : m.isElement(this._config.reference) && ((s = this._config.reference), void 0 !== this._config.reference.jquery && (s = this._config.reference[0])),
                                        "scrollParent" !== this._config.boundary && f(t).addClass(Bt),
                                        (this._popper = new d(s, this._menu, this._getPopperConfig()));
                                }
                                "ontouchstart" in document.documentElement && 0 === f(t).closest(Wt).length && f(document.body).children().on("mouseover", null, f.noop),
                                    this._element.focus(),
                                    this._element.setAttribute("aria-expanded", !0),
                                    f(this._menu).toggleClass(Ot),
                                    f(t).toggleClass(Ot).trigger(f.Event(St.SHOWN, i));
                            }
                        }
                    }
                }),
                (t.show = function () {
                    if (!(this._element.disabled || f(this._element).hasClass(Lt) || f(this._menu).hasClass(Ot))) {
                        var t = { relatedTarget: this._element },
                            e = f.Event(St.SHOW, t),
                            i = c._getParentFromElement(this._element);
                        f(i).trigger(e), e.isDefaultPrevented() || (f(this._menu).toggleClass(Ot), f(i).toggleClass(Ot).trigger(f.Event(St.SHOWN, t)));
                    }
                }),
                (t.hide = function () {
                    if (!this._element.disabled && !f(this._element).hasClass(Lt) && f(this._menu).hasClass(Ot)) {
                        var t = { relatedTarget: this._element },
                            e = f.Event(St.HIDE, t),
                            i = c._getParentFromElement(this._element);
                        f(i).trigger(e), e.isDefaultPrevented() || (f(this._menu).toggleClass(Ot), f(i).toggleClass(Ot).trigger(f.Event(St.HIDDEN, t)));
                    }
                }),
                (t.dispose = function () {
                    f.removeData(this._element, xt), f(this._element).off(It), (this._element = null), (this._menu = null) !== this._popper && (this._popper.destroy(), (this._popper = null));
                }),
                (t.update = function () {
                ...
                (t._addEventListeners = function () {
                    var e = this;
                    f(this._element).on(St.CLICK, function (t) {
                        t.preventDefault(), t.stopPropagation(), e.toggle();
                    });
                }),
                (t._getConfig = function (t) {
                    return (t = l({}, this.constructor.Default, f(this._element).data(), t)), m.typeCheckConfig(Et, t, this.constructor.DefaultType), t;
                }),
                ...
                (t._getPlacement = function () {
                    var t = f(this._element.parentNode),
                        e = qt;
                    return t.hasClass(Pt) ? ((e = zt), f(this._menu).hasClass(Ut) && (e = Yt)) : t.hasClass(Mt) ? (e = Gt) : t.hasClass(Nt) ? (e = Vt) : f(this._menu).hasClass(Ut) && (e = Kt), e;
                }),
                ...
                (c._jQueryInterface = function (e) {
                    return this.each(function () {
                        ...
                        if ((t || ((t = new c(this, "object" == typeof e ? e : null)), f(this).data(xt, t)), "string" == typeof e)) {
                ...
                (c._clearMenus = function (t) {
                    if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
                        for (var e = [].slice.call(document.querySelectorAll(Ft)), i = 0, n = e.length; i < n; i++) {
                            var s = c._getParentFromElement(e[i]),
                                o = f(e[i]).data(xt),
                                a = { relatedTarget: e[i] };
                            if ((t && "click" === t.type && (a.clickEvent = t), o)) {
                                var r = o._menu;
                                if (f(s).hasClass(Ot) && !(t && (("click" === t.type && /input|textarea/i.test(t.target.tagName)) || ("keyup" === t.type && 9 === t.which)) && f.contains(s, t.target))) {
                                    var l = f.Event(St.HIDE, a);
                                    f(s).trigger(l),
                                        l.isDefaultPrevented() ||
                                            ...
                                            f(r).removeClass(Ot),
                                            f(s).removeClass(Ot).trigger(f.Event(St.HIDDEN, a)));
                                }
                            }
                        }
                }),
                ...
                (c._dataApiKeydownHandler = function (t) {
                    if (
                        (/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || (27 !== t.which && ((40 !== t.which && 38 !== t.which) || f(t.target).closest(Rt).length))) : At.test(t.which)) &&
                        (t.preventDefault(), t.stopPropagation(), !this.disabled && !f(this).hasClass(Lt))
                    ) {
                        var e = c._getParentFromElement(this),
                            i = f(e).hasClass(Ot);
                        if (i && (!i || (27 !== t.which && 32 !== t.which))) {
                            var n = [].slice.call(e.querySelectorAll(jt));
                            if (0 !== n.length) {
    ...
    f(document)
        .on(St.KEYDOWN_DATA_API, Ft, Jt._dataApiKeydownHandler)
        .on(St.KEYDOWN_DATA_API, Rt, Jt._dataApiKeydownHandler)
        .on(St.CLICK_DATA_API + " " + St.KEYUP_DATA_API, Jt._clearMenus)
        .on(St.CLICK_DATA_API, Ft, function (t) {
            t.preventDefault(), t.stopPropagation(), Jt._jQueryInterface.call(f(this), "toggle");
        })
        .on(St.CLICK_DATA_API, Ht, function (t) {
            t.stopPropagation();
        }),
        (f.fn[Et] = Jt._jQueryInterface),
        (f.fn[Et].Constructor = Jt),
        (f.fn[Et].noConflict = function () {
            return (f.fn[Et] = Dt), Jt._jQueryInterface;
        });
    var Zt = "modal",
        te = "bs.modal",
        ee = "." + te,
            ...
            return (
                ...
                (t.show = function (t) {
                    ...
                    if (!this._isShown && !this._isTransitioning) {
                        f(this._element).hasClass(he) && (this._isTransitioning = !0);
                        var i = f.Event(oe.SHOW, { relatedTarget: t });
                        f(this._element).trigger(i),
                            this._isShown ||
                                ...
                                f(this._element).on(oe.CLICK_DISMISS, me, function (t) {
                                    return e.hide(t);
                                }),
                                f(this._dialog).on(oe.MOUSEDOWN_DISMISS, function () {
                                    f(e._element).one(oe.MOUSEUP_DISMISS, function (t) {
                ...
                (t.hide = function (t) {
                    ...
                    if ((t && t.preventDefault(), this._isShown && !this._isTransitioning)) {
                        var i = f.Event(oe.HIDE);
                        if ((f(this._element).trigger(i), this._isShown && !i.isDefaultPrevented())) {
                            this._isShown = !1;
                            var n = f(this._element).hasClass(he);
                            if (
                                (n && (this._isTransitioning = !0),
                                this._setEscapeEvent(),
                                this._setResizeEvent(),
                                f(document).off(oe.FOCUSIN),
                                f(this._element).removeClass(de),
                                f(this._element).off(oe.CLICK_DISMISS),
                                f(this._dialog).off(oe.MOUSEDOWN_DISMISS),
                                n)
                            ) {
                ...
                (t._getConfig = function (t) {
                    return (t = l({}, ne, t)), m.typeCheckConfig(Zt, t, se), t;
                }),
                (t._showElement = function (t) {
                    var e = this,
                        i = f(this._element).hasClass(he);
                    (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) || document.body.appendChild(this._element),
                        (this._element.style.display = "block"),
                        this._element.removeAttribute("aria-hidden"),
                        this._element.setAttribute("aria-modal", !0),
                        f(this._dialog).hasClass(ae) ? (this._dialog.querySelector(pe).scrollTop = 0) : (this._element.scrollTop = 0),
                        i && m.reflow(this._element),
                        f(this._element).addClass(de),
                        this._config.focus && this._enforceFocus();
                    function n() {
                        e._config.focus && e._element.focus(), (e._isTransitioning = !1), f(e._element).trigger(s);
                    }
                    var s = f.Event(oe.SHOWN, { relatedTarget: t });
                    if (i) {
                ...
                (t._setEscapeEvent = function () {
                    ...
                    this._isShown && this._config.keyboard
                        ? f(this._element).on(oe.KEYDOWN_DISMISS, function (t) {
                              27 === t.which && (t.preventDefault(), e.hide());
                          })
                        : this._isShown || f(this._element).off(oe.KEYDOWN_DISMISS);
                }),
                (t._setResizeEvent = function () {
                    var e = this;
                    this._isShown
                        ? f(window).on(oe.RESIZE, function (t) {
                              return e.handleUpdate(t);
                          })
                        : f(window).off(oe.RESIZE);
                }),
                (t._hideModal = function () {
                    ...
                    (this._element.style.display = "none"),
                        ...
                        (this._isTransitioning = !1),
                        this._showBackdrop(function () {
                            f(document.body).removeClass(ce), t._resetAdjustments(), t._resetScrollbar(), f(t._element).trigger(oe.HIDDEN);
                        });
                }),
                ...
                (t._showBackdrop = function (t) {
                    var e = this,
                        i = f(this._element).hasClass(he) ? he : "";
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ...
                            f(this._element).on(oe.CLICK_DISMISS, function (t) {
                                e._ignoreBackdropClick ? (e._ignoreBackdropClick = !1) : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide());
                            }),
                            i && m.reflow(this._backdrop),
                            f(this._backdrop).addClass(de),
                            !t)
                        )
                            return;
                        if (!i) return void t();
                        ...
                        f(this._backdrop).removeClass(de);
                        var s = function () {
                            e._removeBackdrop(), t && t();
                        };
                        if (f(this._element).hasClass(he)) {
                ...
                (s._jQueryInterface = function (i, n) {
                    return this.each(function () {
                        var t = f(this).data(te),
                            e = l({}, ne, f(this).data(), "object" == typeof i && i ? i : {});
                        if ((t || ((t = new s(this, e)), f(this).data(te, t)), "string" == typeof i)) {
                            if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                            t[i](n);
    ...
    f(document).on(oe.CLICK_DATA_API, fe, function (t) {
        var e,
            i = this,
            n = m.getSelectorFromElement(this);
        n && (e = document.querySelector(n));
        var s = f(e).data(te) ? "toggle" : l({}, f(e).data(), f(this).data());
        ("A" !== this.tagName && "AREA" !== this.tagName) || t.preventDefault();
        var o = f(e).one(oe.SHOW, function (t) {
            t.isDefaultPrevented() ||
                o.one(oe.HIDDEN, function () {
                    f(i).is(":visible") && i.focus();
                });
        });
        be._jQueryInterface.call(f(e), s, this);
    }),
        (f.fn[Zt] = be._jQueryInterface),
        (f.fn[Zt].Constructor = be),
        (f.fn[Zt].noConflict = function () {
            return (f.fn[Zt] = ie), be._jQueryInterface;
        });
                ...
                n = function (t, e) {
                    ...
                    s.forEach(function (t) {
                        !(function (t, e) {
                            ...
                            if (-1 !== e.indexOf(i)) return -1 === ye.indexOf(i) || Boolean(t.nodeValue.match(we) || t.nodeValue.match(Ce));
                            for (
    ...
    var $e = "tooltip",
        ...
        Ye = (function () {
            ...
            return (
                ...
                (t.toggle = function (t) {
                    if (this._isEnabled)
                        if (t) {
                            ...
                            if (f(this.getTipElement()).hasClass(Be)) return void this._leave(null, this);
                ...
                (t.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        f(s).data(this.constructor.DATA_KEY, this),
                            ...
                            (this._popper = new d(this.element, s, {
                                placement: r,
                                modifiers: { offset: this._getOffset(), flip: { behavior: this.config.fallbackPlacement }, arrow: { element: He }, preventOverflow: { boundariesElement: this.config.boundary } },
                                onCreate: function (t) {
                        ...
                        var c = function () {
                            ...
                            var t = e._hoverState;
                            (e._hoverState = null), f(e.element).trigger(e.constructor.Event.SHOWN), t === Me && e._leave(null, e);
                        };
                ...
                (t.hide = function (t) {
                    function e() {
                        i._hoverState !== Pe && n.parentNode && n.parentNode.removeChild(n),
                            i._cleanTipClass(),
                ...
                (t.addAttachmentClass = function (t) {
                    f(this.getTipElement()).addClass(Te + "-" + t);
                }),
                ...
                (t.setContent = function () {
                    ...
                    this.setElementContent(f(t.querySelectorAll(Fe)), this.getTitle()), f(t).removeClass(Ue + " " + Be);
                }),
                ...
                (t._setListeners = function () {
                    ...
                    this.config.trigger.split(" ").forEach(function (t) {
                        if ("click" === t)
                            ...
                            var e = t === Re ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN,
                                i = t === Re ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT;
                            f(n.element)
                ...
                (t._enter = function (t, e) {
                    ...
                    (e = e || f(t.currentTarget).data(i)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), f(t.currentTarget).data(i, e)),
                        t && (e._activeTrigger["focusin" === t.type ? We : Re] = !0),
                        f(e.getTipElement()).hasClass(Be) || e._hoverState === Pe
                            ? (e._hoverState = Pe)
                ...
                (t._leave = function (t, e) {
                    var i = this.constructor.DATA_KEY;
                    (e = e || f(t.currentTarget).data(i)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), f(t.currentTarget).data(i, e)),
                        t && (e._activeTrigger["focusout" === t.type ? We : Re] = !1),
                ...
                (t._getConfig = function (t) {
                    ...
                    return (
                        ...
                        m.typeCheckConfig($e, t, this.constructor.DefaultType),
                ...
                (n._jQueryInterface = function (i) {
                    return this.each(function () {
                        var t = f(this).data(Ee),
                            e = "object" == typeof i && i;
                        if ((t || !/dispose|hide/.test(i)) && (t || ((t = new n(this, e)), f(this).data(Ee, t)), "string" == typeof i)) {
                            if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                            t[i]();
                        }
                    });
    ...
    (f.fn[$e] = Ye._jQueryInterface),
        (f.fn[$e].Constructor = Ye),
        (f.fn[$e].noConflict = function () {
            return (f.fn[$e] = Ie), Ye._jQueryInterface;
        });
    var qe = "popover",
        Ke = "bs.popover",
        Ge = "." + Ke,
        Ve = f.fn[qe],
        Qe = "bs-popover",
        Xe = new RegExp("(^|\\s)" + Qe + "\\S+", "g"),
        Je = l({}, Ye.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
        Ze = l({}, Ye.DefaultType, { content: "(string|element|function)" }),
        ti = "fade",
        ei = "show",
        ii = ".popover-header",
        ni = ".popover-body",
        ...
        oi = (function (t) {
            ...
            return (
                ...
                (e.addAttachmentClass = function (t) {
                    f(this.getTipElement()).addClass(Qe + "-" + t);
                }),
                ...
                (e.setContent = function () {
                    ...
                    "function" == typeof e && (e = e.call(this.element)), this.setElementContent(t.find(ni), e), t.removeClass(ti + " " + ei);
                }),
                ...
                (n._jQueryInterface = function (i) {
                    return this.each(function () {
                        ...
                        if ((t || !/dispose|hide/.test(i)) && (t || ((t = new n(this, e)), f(this).data(Ke, t)), "string" == typeof i)) {
                            if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                            t[i]();
                        }
                    });
    ...
    (f.fn[qe] = oi._jQueryInterface),
        ...
        (f.fn[qe].noConflict = function () {
            return (f.fn[qe] = Ve), oi._jQueryInterface;
        });
    var ai = "scrollspy",
        ri = "bs.scrollspy",
        li = "." + ri,
        ...
        ui = { ACTIVATE: "activate" + li, SCROLL: "scroll" + li, LOAD_DATA_API: "load" + li + ".data-api" },
        pi = "dropdown-item",
        fi = "active",
        mi = '[data-spy="scroll"]',
        gi = ".nav, .list-group",
        ...
        Ei = (function () {
            function i(t, e) {
                ...
                (this._element = t),
                    ...
                    (this._config = this._getConfig(e)),
                    (this._selector = this._config.target + " " + vi + "," + this._config.target + " " + yi + "," + this._config.target + " " + wi),
                    (this._offsets = []),
                    (this._targets = []),
                    (this._activeTarget = null),
                    (this._scrollHeight = 0),
                    f(this._scrollElement).on(ui.SCROLL, function (t) {
                        return i._process(t);
                    }),
                    this.refresh(),
                    this._process();
            ...
            return (
                (t.refresh = function () {
                    var e = this,
                        t = this._scrollElement === this._scrollElement.window ? ki : $i,
                        s = "auto" === this._config.method ? t : this._config.method,
                        o = s === $i ? this._getScrollTop() : 0;
                    (this._offsets = []),
                        (this._targets = []),
                ...
                (t.dispose = function () {
                    f.removeData(this._element, ri),
                        f(this._scrollElement).off(li),
                        (this._element = null),
                ...
                (t._getConfig = function (t) {
                    if ("string" != typeof (t = l({}, hi, "object" == typeof t && t ? t : {})).target) {
                        ...
                        e || ((e = m.getUID(ai)), f(t.target).attr("id", e)), (t.target = "#" + e);
                    }
                    return m.typeCheckConfig(ai, t, di), t;
                }),
                ...
                (t._activate = function (e) {
                    ...
                    i.hasClass(pi)
                        ? (i.closest(_i).find(Ci).addClass(fi), i.addClass(fi))
                        : (i.addClass(fi),
                          i
                              .parents(gi)
                              .prev(vi + ", " + yi)
                              .addClass(fi),
                          i.parents(gi).prev(bi).children(vi).addClass(fi)),
                        f(this._scrollElement).trigger(ui.ACTIVATE, { relatedTarget: e });
                }),
                (t._clear = function () {
                    [].slice
                        .call(document.querySelectorAll(this._selector))
                ...
                (i._jQueryInterface = function (e) {
                    return this.each(function () {
                        var t = f(this).data(ri);
                        if ((t || ((t = new i(this, "object" == typeof e && e)), f(this).data(ri, t)), "string" == typeof e)) {
                            if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                            t[e]();
                        }
                    });
    ...
    f(window).on(ui.LOAD_DATA_API, function () {
        for (var t = [].slice.call(document.querySelectorAll(mi)), e = t.length; e--; ) {
            var i = f(t[e]);
            Ei._jQueryInterface.call(i, i.data());
        }
    }),
        (f.fn[ai] = Ei._jQueryInterface),
        (f.fn[ai].Constructor = Ei),
        (f.fn[ai].noConflict = function () {
            return (f.fn[ai] = ci), Ei._jQueryInterface;
        });
    var xi = "bs.tab",
        Ii = "." + xi,
        Ti = f.fn.tab,
        Di = { HIDE: "hide" + Ii, HIDDEN: "hidden" + Ii, SHOW: "show" + Ii, SHOWN: "shown" + Ii, CLICK_DATA_API: "click" + Ii + ".data-api" },
        Ai = "dropdown-menu",
        Si = "active",
        Li = "disabled",
        Oi = "fade",
        ...
        Wi = (function () {
            ...
            return (
                (t.show = function () {
                    var i = this;
                    if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && f(this._element).hasClass(Si)) || f(this._element).hasClass(Li))) {
                        var t,
                            n,
                            e = f(this._element).closest(Ni)[0],
                            s = m.getSelectorFromElement(this._element);
                        if (e) {
                            var o = "UL" === e.nodeName || "OL" === e.nodeName ? Bi : Ui;
                            n = (n = f.makeArray(f(e).find(o)))[n.length - 1];
                        }
                        var a = f.Event(Di.HIDE, { relatedTarget: this._element }),
                            r = f.Event(Di.SHOW, { relatedTarget: n });
                        if ((n && f(n).trigger(a), f(this._element).trigger(r), !r.isDefaultPrevented() && !a.isDefaultPrevented())) {
                            ...
                            var l = function () {
                                var t = f.Event(Di.HIDDEN, { relatedTarget: i._element }),
                                    e = f.Event(Di.SHOWN, { relatedTarget: n });
                ...
                (t.dispose = function () {
                    f.removeData(this._element, xi), (this._element = null);
                }),
                (t._activate = function (t, e, i) {
                    ...
                    var s = this,
                        o = (!e || ("UL" !== e.nodeName && "OL" !== e.nodeName) ? f(e).children(Ui) : f(e).find(Bi))[0],
                        a = i && o && f(o).hasClass(Oi);
                    if (o && a) {
                        var r = m.getTransitionDurationFromElement(o);
                        f(o).removeClass(Pi).one(m.TRANSITION_END, n).emulateTransitionEnd(r);
                    } else n();
                }),
                (t._transitionComplete = function (t, e, i) {
                    if (e) {
                        f(e).removeClass(Si);
                        var n = f(e.parentNode).find(Ri)[0];
                        n && f(n).removeClass(Si), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1);
                    }
                    if ((f(t).addClass(Si), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), m.reflow(t), t.classList.contains(Oi) && t.classList.add(Pi), t.parentNode && f(t.parentNode).hasClass(Ai))) {
                        var s = f(t).closest(Mi)[0];
                        if (s) {
                            var o = [].slice.call(s.querySelectorAll(Hi));
                            f(o).addClass(Si);
                        }
                ...
                (n._jQueryInterface = function (i) {
                    return this.each(function () {
                        var t = f(this),
                            e = t.data(xi);
                        if ((e || ((e = new n(this)), t.data(xi, e)), "string" == typeof i)) {
    ...
    f(document).on(Di.CLICK_DATA_API, Fi, function (t) {
        t.preventDefault(), Wi._jQueryInterface.call(f(this), "show");
    }),
        (f.fn.tab = Wi._jQueryInterface),
        (f.fn.tab.Constructor = Wi),
        (f.fn.tab.noConflict = function () {
            return (f.fn.tab = Ti), Wi._jQueryInterface;
        });
    var ji = "toast",
        zi = "bs.toast",
        Yi = "." + zi,
        qi = f.fn[ji],
        Ki = { CLICK_DISMISS: "click.dismiss" + Yi, HIDE: "hide" + Yi, HIDDEN: "hidden" + Yi, SHOW: "show" + Yi, SHOWN: "shown" + Yi },
        Gi = "fade",
        Vi = "hide",
        Qi = "show",
        Xi = "showing",
        ...
        en = (function () {
            ...
            return (
                (t.show = function () {
                    var t = this;
                    f(this._element).trigger(Ki.SHOW), this._config.animation && this._element.classList.add(Gi);
                    function e() {
                        t._element.classList.remove(Xi), t._element.classList.add(Qi), f(t._element).trigger(Ki.SHOWN), t._config.autohide && t.hide();
                    }
                    if ((this._element.classList.remove(Vi), this._element.classList.add(Xi), this._config.animation)) {
                ...
                (t.hide = function (t) {
                    ...
                    this._element.classList.contains(Qi) &&
                        (f(this._element).trigger(Ki.HIDE),
                        t
                            ? this._close()
                ...
                (t.dispose = function () {
                    clearTimeout(this._timeout),
                        (this._timeout = null),
                        this._element.classList.contains(Qi) && this._element.classList.remove(Qi),
                        f(this._element).off(Ki.CLICK_DISMISS),
                        f.removeData(this._element, zi),
                        (this._element = null),
                        (this._config = null);
                }),
                (t._getConfig = function (t) {
                    return (t = l({}, Zi, f(this._element).data(), "object" == typeof t && t ? t : {})), m.typeCheckConfig(ji, t, this.constructor.DefaultType), t;
                }),
                (t._setListeners = function () {
                    var t = this;
                    f(this._element).on(Ki.CLICK_DISMISS, tn, function () {
                        return t.hide(!0);
                    });
                }),
                (t._close = function () {
                    function t() {
                        e._element.classList.add(Vi), f(e._element).trigger(Ki.HIDDEN);
                    }
                    var e = this;
                ...
                (n._jQueryInterface = function (i) {
                    return this.each(function () {
                        var t = f(this),
                            e = t.data(zi);
                        if ((e || ((e = new n(this, "object" == typeof i && i)), t.data(zi, e)), "string" == typeof i)) {
                            if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                            e[i](this);
                        }
                    });
    ...
    (f.fn[ji] = en._jQueryInterface),
        (f.fn[ji].Constructor = en),
        (f.fn[ji].noConflict = function () {
            return (f.fn[ji] = qi), en._jQueryInterface;
        }),
        (function () {
    ...
    (function (P) {
        ...
        function g(t, e) {
            var i = t.nodeName.toLowerCase();
            if (-1 !== P.inArray(i, e)) return -1 === P.inArray(i, a) || Boolean(t.nodeValue.match(r) || t.nodeValue.match(l));
            for (
                var n = P(e).filter(function (t, e) {
                ...
                for (var a = t[s].querySelectorAll("*"), r = 0, l = a.length; r < l; r++) {
                    ...
                    if (-1 !== n.indexOf(h))
                        for (var d = [].slice.call(c.attributes), u = [].concat(e["*"] || [], e[h] || []), p = 0, f = d.length; p < f; p++) {
                            var m = d[p];
                            g(m, u) || c.removeAttribute(m.nodeName);
                        }
        ...
        function T(t, e) {
            for (var i, n = [], s = e || t.selectedOptions, o = 0, a = s.length; o < a; o++) (i = s[o]).disabled || ("OPTGROUP" === i.parentNode.tagName && i.parentNode.disabled) || n.push(i.value || i.text);
        ...
        (i = null),
            String.prototype.startsWith ||
                ...
                (d = {}.toString),
                e ? e(String.prototype, "startsWith", { value: c, configurable: !0, writable: !0 }) : (String.prototype.startsWith = c)),
            Object.keys ||
        ...
        var u = { useDefault: !1, _set: P.valHooks.select.set };
        P.valHooks.select.set = function (t, e) {
            return e && !u.useDefault && P(t).data("selected", !0), u._set.apply(this, arguments);
        };
        var D = null,
            p = (function () {
                try {
        ...
        function C(t, e, i, n) {
            for (var s = ["display", "subtext", "tokens"], o = !1, a = 0; a < s.length; a++) {
                var r = s[a],
                    l = t[r];
                if (l && ((l = l.toString()), "display" === r && (l = l.replace(/<[^>]+>/g, "")), n && (l = y(l)), (l = l.toUpperCase()), (o = "contains" === i ? 0 <= l.indexOf(e) : l.startsWith(e)))) break;
            }
            return o;
        }
        function A(t) {
        ...
        P.fn.triggerNative = function (t) {
            var e,
                i = this[0];
            i.dispatchEvent
                ? (p ? (e = new Event(t, { bubbles: !0 })) : (e = document.createEvent("Event")).initEvent(t, !0, !1), i.dispatchEvent(e))
                : i.fireEvent
        ...
        var _,
            ...
            E =
                ((_ = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;" }),
                (w = "(?:" + Object.keys(_).join("|") + ")"),
                (k = RegExp(w)),
                ($ = RegExp(w, "g")),
                function (t) {
                    return (t = null == t ? "" : "" + t), k.test(t) ? t.replace($, x) : t;
                });
        function x(t) {
            return _[t];
        }
        var I = {
            ...
            F = { success: !1, major: "3" };
        try {
            (F.full = (P.fn.dropdown.Constructor.VERSION || "").split(" ")[0].split(".")), (F.major = F.full[0]), (F.success = !0);
        } catch (t) {}
        var H = 0,
            R = ".bs.select",
            W = {
        ...
        z.a.setAttribute("role", "option"), (z.subtext.className = "text-muted"), (z.text = z.span.cloneNode(!1)), (z.text.className = "text"), (z.checkMark = z.span.cloneNode(!1));
        function Y(t, e) {
            var i = this;
            u.useDefault || ((P.valHooks.select.set = u._set), (u.useDefault = !0)),
                (this.$element = P(t)),
        ...
        var q = new RegExp(U + "|" + B),
            ...
            V = function (t, e, i) {
                ...
                return (
                    t && (11 === t.nodeType ? n.appendChild(t) : n.insertAdjacentHTML("beforeend", t)), void 0 !== e && "" !== e && (n.className = e), "4" === F.major && n.classList.add("dropdown-item"), i && n.setAttribute("style", i), n
                );
            },
            Q = function (t, e) {
                var i,
                ...
                if (t.content) s.innerHTML = t.content;
                    ...
                    if (((s.textContent = t.text), t.icon)) {
                        var o = z.whitespace.cloneNode(!1);
                        ((n = (!0 === e ? z.i : z.span).cloneNode(!1)).className = t.iconBase + " " + t.icon), z.fragment.appendChild(n), z.fragment.appendChild(o);
                    }
                    t.subtext && (((i = z.subtext.cloneNode(!1)).textContent = t.subtext), s.appendChild(i));
                }
                if (!0 === e) for (; 0 < s.childNodes.length; ) z.fragment.appendChild(s.childNodes[0]);
                else z.fragment.appendChild(s);
                return z.fragment;
            },
            X = function (t) {
                var e,
                    i,
                    n = z.text.cloneNode(!1);
                if (((n.innerHTML = t.label), t.icon)) {
                    var s = z.whitespace.cloneNode(!1);
                    ((i = z.span.cloneNode(!1)).className = t.iconBase + " " + t.icon), z.fragment.appendChild(i), z.fragment.appendChild(s);
                }
                return t.subtext && (((e = z.subtext.cloneNode(!1)).textContent = t.subtext), n.appendChild(e)), z.fragment.appendChild(n), z.fragment;
            };
        function J(t) {
            var r,
                l = arguments,
            ...
            if (([].shift.apply(l), !F.success)) {
                try {
                    F.full = (P.fn.dropdown.Constructor.VERSION || "").split(" ")[0].split(".");
                } catch (t) {
                    Y.BootstrapVersion
                        ? (F.full = Y.BootstrapVersion.split(" ")[0].split("."))
                        : ((F.full = [F.major, "0", "0"]),
                          console.warn(
            ...
            if ("4" === F.major) {
                var e = [];
                Y.DEFAULTS.style === W.BUTTONCLASS && e.push({ name: "style", className: "BUTTONCLASS" }),
                    Y.DEFAULTS.iconBase === W.ICONBASE && e.push({ name: "iconBase", className: "ICONBASE" }),
                    Y.DEFAULTS.tickIcon === W.TICKICON && e.push({ name: "tickIcon", className: "TICKICON" }),
                    (W.DIVIDER = "dropdown-divider"),
                    (W.SHOW = "show"),
                    (W.BUTTONCLASS = "btn-light"),
                    (W.POPOVERHEADER = "popover-header"),
                    (W.ICONBASE = ""),
                    (W.TICKICON = "bs-ok-default");
                for (var i = 0; i < e.length; i++) {
                    t = e[i];
                    Y.DEFAULTS[t.name] = W[t.className];
                }
            }
            var n = this.each(function () {
                ...
                if (t.is("select")) {
                    ...
                    if (e) {
                        ...
                        var s = t.data();
                        for (var o in s) s.hasOwnProperty(o) && -1 !== P.inArray(o, h) && delete s[o];
                        var a = P.extend({}, Y.DEFAULTS, P.fn.selectpicker.defaults || {}, s, i);
                        (a.template = P.extend({}, Y.DEFAULTS.template, P.fn.selectpicker.defaults ? P.fn.selectpicker.defaults.template : {}, s.template, i.template)), t.data("selectpicker", (e = new Y(this, a)));
                    }
            ...
            (Y.prototype = {
                ...
                init: function () {
                    ...
                    H++,
                        ...
                        (this.$menu = this.$newElement.children(j.MENU)),
                        (this.$menuInner = this.$menu.children(".inner")),
                        (this.$searchbox = this.$menu.find("input")),
                        this.$element[0].classList.remove("bs-select-hidden"),
                        !0 === this.options.dropdownAlignRight && this.$menu[0].classList.add(W.MENURIGHT),
                        ...
                        this.options.container
                            ? this.selectPosition()
                            : this.$element.on("hide" + R, function () {
                                  if (i.isVirtual()) {
                                      var t = i.$menuInner[0],
                        ...
                        this.$newElement.on({
                            "hide.bs.dropdown": function (t) {
                                i.$element.trigger("hide" + R, t);
                            },
                            "hidden.bs.dropdown": function (t) {
                                i.$element.trigger("hidden" + R, t);
                            },
                            "show.bs.dropdown": function (t) {
                                i.$element.trigger("show" + R, t);
                            },
                            "shown.bs.dropdown": function (t) {
                                i.$element.trigger("shown" + R, t);
                            },
                        }),
                        i.$element[0].hasAttribute("required") &&
                            this.$element.on("invalid" + R, function () {
                                i.$button[0].classList.add("bs-invalid"),
                                    i.$element
                                        .on("shown" + R + ".invalid", function () {
                                            i.$element.val(i.$element.val()).off("shown" + R + ".invalid");
                                        })
                                        .on("rendered" + R, function () {
                                            this.validity.valid && i.$button[0].classList.remove("bs-invalid"), i.$element.off("rendered" + R);
                                        }),
                                    i.$button.on("blur" + R, function () {
                                        i.$element.trigger("focus").trigger("blur"), i.$button.off("blur" + R);
                                    });
                            }),
                        setTimeout(function () {
                            i.createLi(), i.$element.trigger("loaded" + R);
                        });
                },
                createDropdown: function () {
                    ...
                    var s,
                        ...
                        l = "";
                    return (
                        this.options.header && (o = '<div class="' + W.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
                        this.options.liveSearch &&
                            (a =
                                '<div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off"' +
                                (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + E(this.options.liveSearchPlaceholder) + '"') +
                        ...
                        this.multiple &&
                            ...
                            (l = '<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm ' + W.BUTTONCLASS + '">' + this.options.doneButtonText + "</button></div></div>"),
                        (s =
                ...
                createView: function (D, t, e) {
                    var A,
                        S,
                        L = this,
                        i = 0,
                        O = [];
                    if (((this.selectpicker.current = D ? this.selectpicker.search : this.selectpicker.main), this.setPositionData(), t))
                        if (e) i = this.$menuInner[0].scrollTop;
                        else if (!L.multiple) {
                            var n = L.$element[0],
                                s = (n.options[n.selectedIndex] || {}).liIndex;
                            if ("number" == typeof s && !1 !== L.options.size) {
                                var o = L.selectpicker.main.data[s],
                                    a = o && o.position;
                                a && (i = a - (L.sizeInfo.menuInnerHeight + L.sizeInfo.liHeight) / 2);
                            }
                        }
                    function r(t, e) {
                        var i,
                            ...
                            l,
                            c,
                            h = L.selectpicker.current.elements.length,
                            d = [],
                            u = !0,
                            p = L.isVirtual();
                        (L.selectpicker.view.scrollTop = t),
                            !0 === p &&
                                L.sizeInfo.hasScrollBar &&
                                L.$menu[0].offsetWidth > L.sizeInfo.totalMenuWidth &&
                                ((L.sizeInfo.menuWidth = L.$menu[0].offsetWidth), (L.sizeInfo.totalMenuWidth = L.sizeInfo.menuWidth + L.sizeInfo.scrollBarWidth), L.$menu.css("min-width", L.sizeInfo.menuWidth)),
                            (i = Math.ceil((L.sizeInfo.menuInnerHeight / L.sizeInfo.liHeight) * 1.5)),
                            (n = Math.round(h / i) || 1);
                        for (var f = 0; f < n; f++) {
                            var m = (f + 1) * i;
                            if ((f === n - 1 && (m = h), (d[f] = [f * i + (f ? 1 : 0), m]), !h)) break;
                            void 0 === a && t <= L.selectpicker.current.data[m - 1].position - L.sizeInfo.menuInnerHeight && (a = f);
                        }
                        if (
                            (void 0 === a && (a = 0),
                            (r = [L.selectpicker.view.position0, L.selectpicker.view.position1]),
                            (s = Math.max(0, a - 1)),
                            (o = Math.min(n - 1, a + 1)),
                            (L.selectpicker.view.position0 = !1 === p ? 0 : Math.max(0, d[s][0]) || 0),
                            (L.selectpicker.view.position1 = !1 === p ? h : Math.min(h, d[o][1]) || 0),
                            (l = r[0] !== L.selectpicker.view.position0 || r[1] !== L.selectpicker.view.position1),
                            void 0 !== L.activeIndex &&
                                ((S = L.selectpicker.main.elements[L.prevActiveIndex]),
                                (O = L.selectpicker.main.elements[L.activeIndex]),
                                (A = L.selectpicker.main.elements[L.selectedIndex]),
                                e && (L.activeIndex !== L.selectedIndex && L.defocusItem(O), (L.activeIndex = void 0)),
                                L.activeIndex && L.activeIndex !== L.selectedIndex && L.defocusItem(A)),
                            void 0 !== L.prevActiveIndex && L.prevActiveIndex !== L.activeIndex && L.prevActiveIndex !== L.selectedIndex && L.defocusItem(S),
                            (e || l) &&
                                ((c = L.selectpicker.view.visibleElements ? L.selectpicker.view.visibleElements.slice() : []),
                                (L.selectpicker.view.visibleElements = !1 === p ? L.selectpicker.current.elements : L.selectpicker.current.elements.slice(L.selectpicker.view.position0, L.selectpicker.view.position1)),
                                L.setOptionStatus(),
                                (D || (!1 === p && e)) &&
                                    (u = !(function (t, i) {
                                        return (
                                    ...
                                    })(c, L.selectpicker.view.visibleElements)),
                                (e || !0 === p) && u))
                        ) {
                            var g,
                                v,
                                ...
                                _ = b.firstChild.cloneNode(!1),
                                w = L.selectpicker.view.visibleElements,
                                C = [];
                            b.replaceChild(_, b.firstChild);
                            f = 0;
                            for (var k = w.length; f < k; f++) {
                                var $,
                                    E,
                                    x = w[f];
                                L.options.sanitize && ($ = x.lastChild) && (E = L.selectpicker.current.data[f + L.selectpicker.view.position0]) && E.content && !E.sanitized && (C.push($), (E.sanitized = !0)), y.appendChild(x);
                            }
                            L.options.sanitize && C.length && M(C, L.options.whiteList, L.options.sanitizeFn),
                                !0 === p
                                    ? ((g = 0 === L.selectpicker.view.position0 ? 0 : L.selectpicker.current.data[L.selectpicker.view.position0 - 1].position),
                                      (v = L.selectpicker.view.position1 > h - 1 ? 0 : L.selectpicker.current.data[h - 1].position - L.selectpicker.current.data[L.selectpicker.view.position1 - 1].position),
                                      (b.firstChild.style.marginTop = g + "px"),
                                      (b.firstChild.style.marginBottom = v + "px"))
                                    : ((b.firstChild.style.marginTop = 0), (b.firstChild.style.marginBottom = 0)),
                                b.firstChild.appendChild(y);
                        }
                        if (((L.prevActiveIndex = L.activeIndex), L.options.liveSearch)) {
                            if (D && e) {
                                var I,
                                    T = 0;
                                L.selectpicker.view.canHighlight[T] || (T = 1 + L.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                                    (I = L.selectpicker.view.visibleElements[T]),
                                    L.defocusItem(L.selectpicker.view.currentActive),
                                    (L.activeIndex = (L.selectpicker.current.data[T] || {}).index),
                                    L.focusItem(I);
                            }
                    ...
                    r(i, !0),
                        this.$menuInner.off("scroll.createView").on("scroll.createView", function (t, e) {
                            L.noScroll || r(this.scrollTop, e), (L.noScroll = !1);
                        }),
                        P(window)
                            .off("resize" + R + "." + this.selectId + ".createView")
                            .on("resize" + R + "." + this.selectId + ".createView", function () {
                                L.$newElement.hasClass(W.SHOW) && r(L.$menuInner[0].scrollTop);
                            });
                },
                    ...
                    if (this.options.title && !this.multiple) {
                        ...
                        if (n)
                            (this.selectpicker.view.titleOption.className = "bs-title-option"),
                                ...
                                (i = void 0 === P(e.options[e.selectedIndex]).attr("selected") && void 0 === this.$element.data("selected"));
                        (!n && 0 === this.selectpicker.view.titleOption.index) || e.insertBefore(this.selectpicker.view.titleOption, e.firstChild), i && (e.selectedIndex = 0);
                    }
                    return t;
                },
                createLi: function () {
                    ...
                    this.options.hideDisabled && (m += ":not(:disabled)"),
                        (!c.options.showTick && !c.multiple) || z.checkMark.parentNode || ((z.checkMark.className = f + " " + c.options.tickIcon + " check-mark"), z.a.appendChild(z.checkMark));
                    var e = this.$element[0].querySelectorAll("select > *" + m);
                    function y(t) {
                        var e = v[v.length - 1];
                        (e && "divider" === e.type && (e.optID || t.optID)) || (((t = t || {}).type = "divider"), g.push(G(!1, W.DIVIDER, t.optID ? t.optID + "div" : void 0)), v.push(t));
                    }
                    function _(t, e) {
                        if ((((e = e || {}).divider = "true" === t.getAttribute("data-divider")), e.divider)) y({ optID: e.optID });
                        else {
                            var i = v.length,
                                n = t.style.cssText,
                                s = n ? E(n) : "",
                            ...
                            var a = Q(e),
                                r = G(V(a, o, s), "", e.optID);
                            r.firstChild && (r.firstChild.id = c.selectId + "-" + i),
                                g.push(r),
                                (t.liIndex = i),
                                ...
                                v.push(e);
                            var l = 0;
                            e.display && (l += e.display.length), e.subtext && (l += e.subtext.length), e.icon && (l += 1), h < l && ((h = l), (c.selectpicker.view.widestOption = g[g.length - 1]));
                        }
                    }
                    function i(t, e) {
                        var i = e[t],
                        ...
                        if (o.length) {
                            var a,
                                r,
                                l = { label: E(i.label), subtext: i.getAttribute("data-subtext"), icon: i.getAttribute("data-icon"), iconBase: f },
                                c = " " + (i.className || "");
                            b++, n && y({ optID: b });
                            var h = X(l);
                            g.push(G(h, "dropdown-header" + c, b)), v.push({ display: l.label, subtext: l.subtext, type: "optgroup-label", optID: b });
                            for (var d = 0, u = o.length; d < u; d++) {
                                var p = o[d];
                                0 === d && (r = (a = v.length - 1) + u), _(p, { headerIndex: a, lastIndex: r, optID: b, optgroupClass: c, disabled: i.disabled });
                            }
                            s && y({ optID: b });
                        }
                    }
                ...
                render: function () {
                    ...
                    var t,
                        ...
                        n = (function (t, e) {
                            ...
                            return n;
                        })(i, this.options.hideDisabled),
                        s = n.length,
                        o = this.$button[0],
                        a = o.querySelector(".filter-option-inner-inner"),
                        r = document.createTextNode(this.options.multipleSeparator),
                        l = z.fragment.cloneNode(!1),
                        c = !1;
                    if ((o.classList.toggle("bs-placeholder", e.multiple ? !s : !T(i, n)), this.tabIndex(), "static" === this.options.selectedTextFormat)) l = Q({ text: this.options.title }, !0);
                        ...
                        for (var h = 0; h < s && h < 50; h++) {
                            var d = n[h],
                                u = {},
                                p = { content: d.getAttribute("data-content"), subtext: d.getAttribute("data-subtext"), icon: d.getAttribute("data-icon") };
                            this.multiple && 0 < h && l.appendChild(r.cloneNode(!1)),
                                d.title
                                    ? (u.text = d.title)
                                    : p.content && e.options.showContent
                                    ? ((u.content = p.content.toString()), (c = !0))
                                    : (e.options.showIcon && ((u.icon = p.icon), (u.iconBase = this.options.iconBase)), e.options.showSubtext && !e.multiple && p.subtext && (u.subtext = " " + p.subtext), (u.text = d.textContent.trim())),
                                l.appendChild(Q(u, !0));
                        }
                        ...
                        var m = this.$element[0].querySelectorAll("select > option" + f + ", optgroup" + f + " option" + f).length,
                            g = "function" == typeof this.options.countSelectedText ? this.options.countSelectedText(s, m) : this.options.countSelectedText;
                        l = Q({ text: g.replace("{0}", s.toString()).replace("{1}", m.toString()) }, !0);
                    }
                    if (
                        (null == this.options.title && (this.options.title = this.$element.attr("title")),
                        l.childNodes.length || (l = Q({ text: void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText }, !0)),
                        (o.title = l.textContent.replace(/<[^>]*>?/g, "").trim()),
                        this.options.sanitize && c && M([l], e.options.whiteList, e.options.sanitizeFn),
                        (a.innerHTML = ""),
                        a.appendChild(l),
                        F.major < 4 && this.$newElement[0].classList.contains("bs3-has-addon"))
                    ) {
                        var v = o.querySelector(".filter-expand"),
                            b = a.cloneNode(!0);
                        (b.className = "filter-expand"), v ? o.replaceChild(b, v) : o.appendChild(b);
                    }
                    this.$element.trigger("rendered" + R);
                },
                ...
                liHeight: function (t) {
                    if (t || (!1 !== this.options.size && !this.sizeInfo)) {
                        ...
                        var e = document.createElement("div"),
                            ...
                            h = this.options.header && 0 < this.$menu.find("." + W.POPOVERHEADER).length ? this.$menu.find("." + W.POPOVERHEADER)[0].cloneNode(!0) : null,
                        ...
                        if (
                            ...
                            (c.className = "text"),
                            (l.className = "dropdown-item " + (f ? f.className : "")),
                            (e.className = this.$menu[0].parentNode.className + " " + W.SHOW),
                            (e.style.width = this.sizeInfo.selectWidth + "px"),
                            "auto" === this.options.width && (i.style.minWidth = 0),
                            (i.className = W.MENU + " " + W.SHOW),
                            (n.className = "inner " + W.SHOW),
                            (s.className = W.MENU + " inner " + ("4" === F.major ? W.SHOW : "")),
                            (o.className = W.DIVIDER),
                            ...
                            (d.className = "bs-searchbox"), (m.className = "form-control"), d.appendChild(m), i.appendChild(d);
                        }
                        u && i.appendChild(u), n.appendChild(s), i.appendChild(n), p && i.appendChild(p), e.appendChild(i), document.body.appendChild(e);
                        var g,
                            v = r.offsetHeight,
                            b = a ? a.offsetHeight : 0,
                            y = h ? h.offsetHeight : 0,
                            _ = d ? d.offsetHeight : 0,
                            ...
                            x = $ ? null : P(i),
                            I = {
                                vert: A($ ? $.paddingTop : x.css("paddingTop")) + A($ ? $.paddingBottom : x.css("paddingBottom")) + A($ ? $.borderTopWidth : x.css("borderTopWidth")) + A($ ? $.borderBottomWidth : x.css("borderBottomWidth")),
                                horiz:
                                    A($ ? $.paddingLeft : x.css("paddingLeft")) + A($ ? $.paddingRight : x.css("paddingRight")) + A($ ? $.borderLeftWidth : x.css("borderLeftWidth")) + A($ ? $.borderRightWidth : x.css("borderRightWidth")),
                            },
                            T = {
                                vert: I.vert + A($ ? $.marginTop : x.css("marginTop")) + A($ ? $.marginBottom : x.css("marginBottom")) + 2,
                                horiz: I.horiz + A($ ? $.marginLeft : x.css("marginLeft")) + A($ ? $.marginRight : x.css("marginRight")) + 2,
                            };
                ...
                setMenuSize: function (t) {
                    ...
                    if (
                        (this.options.dropupAuto &&
                            ...
                            this.$newElement.toggleClass(W.DROPUP, this.sizeInfo.selectOffsetTop - this.sizeInfo.selectOffsetBot > this.sizeInfo.menuExtras.vert && r + this.sizeInfo.menuExtras.vert + 50 > this.sizeInfo.selectOffsetBot)),
                        ...
                        (s = 3 < this.selectpicker.current.elements.length ? 3 * this.sizeInfo.liHeight + this.sizeInfo.menuExtras.vert - 2 : 0),
                            ...
                            (n = s + h + d + u + p),
                            (a = Math.max(s - m.vert, 0)),
                            this.$newElement.hasClass(W.DROPUP) && (i = this.sizeInfo.selectOffsetTop - this.sizeInfo.menuExtras.vert),
                            (e = (o = i) - h - d - u - p - m.vert);
                    else if (this.options.size && "auto" != this.options.size && this.selectpicker.current.elements.length > this.options.size) {
                        for (var v = 0; v < this.options.size; v++) "divider" === this.selectpicker.current.data[v].type && g++;
                        (e = (i = c * this.options.size + g * f + m.vert) - m.vert), (o = i + h + d + u + p), (n = a = "");
                    }
                    "auto" === this.options.dropdownAlignRight && this.$menu.toggleClass(W.MENURIGHT, this.sizeInfo.selectOffsetLeft > this.sizeInfo.selectOffsetRight && this.sizeInfo.selectOffsetRight < this.sizeInfo.totalMenuWidth - l),
                        this.$menu.css({ "max-height": "300px", overflow: "hidden", "min-height": "10px" }),
                        this.$menuInner.css({ "max-height": e + "px", "overflow-y": "auto", "min-height": a + "px" }),
                ...
                setSize: function (t) {
                    if ((this.liHeight(t), this.options.header && this.$menu.css("padding-top", 0), !1 !== this.options.size)) {
                        ...
                        this.setMenuSize(),
                            ...
                            "auto" === this.options.size
                                ? i
                                      .off("resize" + R + "." + this.selectId + ".setMenuSize scroll" + R + "." + this.selectId + ".setMenuSize")
                                      .on("resize" + R + "." + this.selectId + ".setMenuSize scroll" + R + "." + this.selectId + ".setMenuSize", function () {
                                          return e.setMenuSize();
                                      })
                                : this.options.size &&
                                  "auto" != this.options.size &&
                                  this.selectpicker.current.elements.length > this.options.size &&
                                  i.off("resize" + R + "." + this.selectId + ".setMenuSize scroll" + R + "." + this.selectId + ".setMenuSize"),
                            e.createView(!1, !0, t);
                    }
                },
                setWidth: function () {
                    ...
                    "auto" === this.options.width
                        ? requestAnimationFrame(function () {
                              i.$menu.css("min-width", "0"),
                                  i.$element.on("loaded" + R, function () {
                ...
                selectPosition: function () {
                    ...
                    function t(t) {
                        var e = {},
                            i = a.options.display || (!!P.fn.dropdown.Constructor.Default && P.fn.dropdown.Constructor.Default.display);
                        a.$bsContainer.addClass(t.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(W.DROPUP, t.hasClass(W.DROPUP)),
                            (n = t.offset()),
                            ...
                            (o = t.hasClass(W.DROPUP) ? 0 : t[0].offsetHeight),
                    ...
                    var n,
                        ...
                        o,
                        a = this,
                        r = P(this.options.container);
                    this.$button.on("click.bs.dropdown.data-api", function () {
                        a.isDisabled() || (t(a.$newElement), a.$bsContainer.appendTo(a.options.container).toggleClass(W.SHOW, !a.$button.hasClass(W.SHOW)).append(a.$menu));
                    }),
                        P(window)
                            .off("resize" + R + "." + this.selectId + " scroll" + R + "." + this.selectId)
                            .on("resize" + R + "." + this.selectId + " scroll" + R + "." + this.selectId, function () {
                                a.$newElement.hasClass(W.SHOW) && t(a.$newElement);
                            }),
                        this.$element.on("hide" + R, function () {
                ...
                setDisabled: function (t, e) {
                    ...
                    (this.selectpicker.main.data[t].disabled = e),
                        (i = n.firstChild),
                        n.classList.toggle(W.DISABLED, e),
                        i && ("4" === F.major && i.classList.toggle(W.DISABLED, e), e ? (i.setAttribute("aria-disabled", e), i.setAttribute("tabindex", -1)) : (i.removeAttribute("aria-disabled"), i.setAttribute("tabindex", 0)));
                },
                isDisabled: function () {
                ...
                checkDisabled: function () {
                    var t = this;
                    this.isDisabled()
                        ? (this.$newElement[0].classList.add(W.DISABLED), this.$button.addClass(W.DISABLED).attr("tabindex", -1).attr("aria-disabled", !0))
                        : (this.$button[0].classList.contains(W.DISABLED) && (this.$newElement[0].classList.remove(W.DISABLED), this.$button.removeClass(W.DISABLED).attr("aria-disabled", !1)),
                ...
                clickListener: function () {
                    var I = this,
                        e = P(document);
                    function t() {
                        I.options.liveSearch ? I.$searchbox.trigger("focus") : I.$menuInner.trigger("focus");
                    }
                    function i() {
                        I.dropdown && I.dropdown._popper && I.dropdown._popper.state.isCreated ? t() : requestAnimationFrame(i);
                    }
                    e.data("spaceSelect", !1),
                        ...
                        this.$newElement.on("show.bs.dropdown", function () {
                            3 < F.major && !I.dropdown && ((I.dropdown = I.$button.data("bs.dropdown")), (I.dropdown._menu = I.$menu[0]));
                        }),
                        this.$button.on("click.bs.dropdown.data-api", function () {
                            I.$newElement.hasClass(W.SHOW) || I.setSize();
                        }),
                        this.$element.on("shown" + R, function () {
                            I.$menuInner[0].scrollTop !== I.selectpicker.view.scrollTop && (I.$menuInner[0].scrollTop = I.selectpicker.view.scrollTop), 3 < F.major ? requestAnimationFrame(i) : t();
                        }),
                        this.$menuInner.on("mouseenter", "li a", function (t) {
                            var e = this.parentElement,
                                ...
                                s = I.selectpicker.current.data[n + i];
                            I.focusItem(e, s, !0);
                        }),
                        this.$menuInner.on("click", "li a", function (t, e) {
                            var i = P(this),
                                n = I.$element[0],
                                s = I.isVirtual() ? I.selectpicker.view.position0 : 0,
                                o = I.selectpicker.current.data[i.parent().index() + s],
                                a = o.index,
                                r = T(n),
                                l = n.selectedIndex,
                                c = n.options[l],
                                h = !0;
                            if ((I.multiple && 1 !== I.options.maxOptions && t.stopPropagation(), t.preventDefault(), !I.isDisabled() && !i.parent().hasClass(W.DISABLED))) {
                                var d = I.$element.find("option"),
                                    u = o.option,
                                    p = P(u),
                                    f = u.selected,
                                    m = p.parent("optgroup"),
                                    g = m.find("option"),
                                    v = I.options.maxOptions,
                                    b = m.data("maxOptions") || !1;
                                if ((a === I.activeIndex && (e = !0), e || ((I.prevActiveIndex = I.activeIndex), (I.activeIndex = void 0)), I.multiple)) {
                                    if (((u.selected = !f), I.setSelected(a, !f), i.trigger("blur"), !1 !== v || !1 !== b)) {
                                        var y = v < d.filter(":selected").length,
                                            _ = b < m.find("option:selected").length;
                                        if ((v && y) || (b && _))
                                            if (v && 1 == v) {
                                                d.prop("selected", !1), p.prop("selected", !0);
                                                for (var w = 0; w < d.length; w++) I.setSelected(w, !1);
                                                I.setSelected(a, !0);
                                            } else if (b && 1 == b) {
                                                m.find("option:selected").prop("selected", !1), p.prop("selected", !0);
                                                for (w = 0; w < g.length; w++) {
                                                    u = g[w];
                                                    I.setSelected(d.index(u), !1);
                                                }
                                                I.setSelected(a, !0);
                                            } else {
                                                var C = "string" == typeof I.options.maxOptionsText ? [I.options.maxOptionsText, I.options.maxOptionsText] : I.options.maxOptionsText,
                                                    k = "function" == typeof C ? C(v, b) : C,
                                                    $ = k[0].replace("{n}", v),
                                                    E = k[1].replace("{n}", b),
                                                    x = P('<div class="notify"></div>');
                                                k[2] && (($ = $.replace("{var}", k[2][1 < v ? 0 : 1])), (E = E.replace("{var}", k[2][1 < b ? 0 : 1]))),
                                                    p.prop("selected", !1),
                                                    I.$menu.append(x),
                                                    v && y && (x.append(P("<div>" + $ + "</div>")), (h = !1), I.$element.trigger("maxReached" + R)),
                                                    b && _ && (x.append(P("<div>" + E + "</div>")), (h = !1), I.$element.trigger("maxReachedGrp" + R)),
                                                    setTimeout(function () {
                                                        I.setSelected(a, !1);
                                                    }, 10),
                                ...
                                } else (c.selected = !1), (u.selected = !0), I.setSelected(a, !0);
                                !I.multiple || (I.multiple && 1 === I.options.maxOptions) ? I.$button.trigger("focus") : I.options.liveSearch && I.$searchbox.trigger("focus"),
                                    h && ((!I.multiple && l === n.selectedIndex) || ((D = [u.index, p.prop("selected"), r]), I.$element.triggerNative("change")));
                            }
                        }),
                        this.$menu.on("click", "li." + W.DISABLED + " a, ." + W.POPOVERHEADER + ", ." + W.POPOVERHEADER + " :not(.close)", function (t) {
                            t.currentTarget == this && (t.preventDefault(), t.stopPropagation(), I.options.liveSearch && !P(t.target).hasClass("close") ? I.$searchbox.trigger("focus") : I.$button.trigger("focus"));
                        }),
                        this.$menuInner.on("click", ".divider, .dropdown-header", function (t) {
                            t.preventDefault(), t.stopPropagation(), I.options.liveSearch ? I.$searchbox.trigger("focus") : I.$button.trigger("focus");
                        }),
                        this.$menu.on("click", "." + W.POPOVERHEADER + " .close", function () {
                        ...
                        this.$menu.on("click", ".actions-btn", function (t) {
                            I.options.liveSearch ? I.$searchbox.trigger("focus") : I.$button.trigger("focus"), t.preventDefault(), t.stopPropagation(), P(this).hasClass("bs-select-all") ? I.selectAll() : I.deselectAll();
                        }),
                        this.$element
                            .on("change" + R, function () {
                                I.render(), I.$element.trigger("changed" + R, D), (D = null);
                            })
                            .on("focus" + R, function () {
                    ...
                    this.$button.on("click.bs.dropdown.data-api", function () {
                        ...
                        this.$searchbox.on("input propertychange", function () {
                            ...
                            if (((p.selectpicker.search.elements = []), (p.selectpicker.search.data = []), t)) {
                                ...
                                a && (i = y(i)), (p._$lisSelected = p.$menuInner.find(".selected"));
                                ...
                                for (var c = s.length; r < c; r++) {
                                    var h = s[r],
                                        d = s[r - 1],
                                        u = ((l = p.selectpicker.main.data[h]), p.selectpicker.main.data[d]);
                                ...
                                (p.activeIndex = void 0),
                                    ...
                                    p.createView(!0),
                                    e.length || ((f.className = "no-results"), (f.innerHTML = p.options.noneResultsText.replace("{0}", '"' + E(t) + '"')), p.$menuInner[0].firstChild.appendChild(f));
                ...
                val: function (t) {
                    ...
                    var i = T(e);
                    if (((D = [null, null, i]), this.$element.val(t).trigger("changed" + R, D), this.$newElement.hasClass(W.SHOW)))
                ...
                changeAll: function (t) {
                    if (this.multiple) {
                        ...
                        for (var o = 0, a = this.selectpicker.current.elements.length; o < a; o++) {
                            var r = this.selectpicker.current.data[o],
                                l = r.option;
                            l && !r.disabled && "divider" !== r.type && (r.selected && i++, (l.selected = t) && n++);
                        }
                        e.classList.remove("bs-select-hidden"), i !== n && (this.setOptionStatus(), (D = [null, null, s]), this.$element.triggerNative("change"));
                    }
                },
                selectAll: function () {
                ...
                keydown: function (t) {
                    var e,
                        ...
                        l = (r ? a.closest(".dropdown") : a.closest(j.MENU)).data("this"),
                        c = l.findLis(),
                        h = !1,
                        d = t.which === N && !r && !l.options.selectOnTab,
                        u = q.test(t.which) || d,
                        p = l.$menuInner[0].scrollTop,
                        f = !0 === l.isVirtual() ? l.selectpicker.view.position0 : 0;
                    if (
                        !(i = l.$newElement.hasClass(W.SHOW)) &&
                        ...
                        if ((t.which === S && i && (t.preventDefault(), l.$button.trigger("click.bs.dropdown.data-api").trigger("focus")), u)) {
                            if (!c.length) return;
                        ...
                        } else if ((!a.is("input") && !K.test(t.which)) || (t.which === O && l.selectpicker.keydown.keyHistory)) {
                            var g,
                                v,
                                b = [];
                            t.preventDefault(),
                                (l.selectpicker.keydown.keyHistory += I[t.which]),
                            ...
                            for (var y = 0; y < l.selectpicker.current.data.length; y++) {
                                var _ = l.selectpicker.current.data[y];
                                C(_, v, "startsWith", !0) && l.selectpicker.view.canHighlight[y] && b.push(_.index);
                            }
                            if (b.length) {
                                var w = 0;
                                c.removeClass("active").find("a").removeClass("active"),
                                    1 === v.length && (-1 === (w = b.indexOf(l.activeIndex)) || w === b.length - 1 ? (w = 0) : w++),
                                    (g = b[w]),
                        ...
                        i &&
                            ((t.which === O && !l.selectpicker.keydown.keyHistory) || t.which === L || (t.which === N && l.options.selectOnTab)) &&
                            (t.which !== O && t.preventDefault(),
                            (l.options.liveSearch && t.which === O) || (l.$menuInner.find(".active a").trigger("click", !0), a.trigger("focus"), l.options.liveSearch || (t.preventDefault(), P(document).data("spaceSelect", !0))));
                    }
                },
                mobile: function () {
                ...
                refresh: function () {
                    var t = P.extend({}, this.options, this.$element.data());
                    (this.options = t), this.checkDisabled(), this.setStyle(), this.render(), this.createLi(), this.setWidth(), this.setSize(!0), this.$element.trigger("refreshed" + R);
                },
                hide: function () {
                ...
                destroy: function () {
                    this.$newElement.before(this.$element).remove(),
                        ...
                        this.$element.off(R).removeData("selectpicker").removeClass("bs-select-hidden selectpicker"),
                        P(window).off(R + "." + this.selectId);
                },
            });
        var Z = P.fn.selectpicker;
        (P.fn.selectpicker = J),
            (P.fn.selectpicker.Constructor = Y),
            (P.fn.selectpicker.noConflict = function () {
                return (P.fn.selectpicker = Z), this;
            }),
            P(document)
                .off("keydown.bs.dropdown.data-api")
                .on("keydown" + R, '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', Y.prototype.keydown)
            ...
            P(window).on("load" + R + ".data-api", function () {
    ...
    (function () {
        ...
        if ("undefined" != typeof window && window.addEventListener) {
            ...
            (t = function () {
                        ...
                        (function () {
                            ...
                            window.addEventListener("resize", w, !1),
                                ...
                                (C = window.MutationObserver
                                    ? ((t = new MutationObserver(w)).observe(document.documentElement, { childList: !0, subtree: !0, attributes: !0 }),
                                      function () {
                                          try {
                                              t.disconnect(), window.removeEventListener("resize", w, !1), window.removeEventListener("orientationchange", w, !1);
                                          } catch (t) {}
                                      })
                                    : (document.documentElement.addEventListener("DOMSubtreeModified", w, !1),
                                      function () {
                                          document.documentElement.removeEventListener("DOMSubtreeModified", w, !1), window.removeEventListener("resize", w, !1), window.removeEventListener("orientationchange", w, !1);
                                      }));
                        })());
                }
                function g(t) {
                    return function () {
                        !0 !== _[t.base] && (t.useEl.setAttributeNS(k, "xlink:href", "#" + t.hash), t.useEl.hasAttribute("href") && t.useEl.setAttribute("href", "#" + t.hash));
                    };
                }
                function v(n) {
                    return function () {
                ...
                for (C(), l = document.getElementsByTagName("use"), s = 0; s < l.length; s += 1) {
                    try {
                        e = l[s].getBoundingClientRect();
                    } catch (t) {
                        e = !1;
                    }
                    (t = (r = (n = l[s].getAttribute("href") || l[s].getAttributeNS(k, "href") || l[s].getAttribute("xlink:href")) && n.split ? n.split("#") : ["", ""])[0]),
                        (i = r[1]),
                        (o = e && 0 === e.left && 0 === e.right && 0 === e.top && 0 === e.bottom),
                        e && 0 === e.width && 0 === e.height && !o
                            ? (l[s].hasAttribute("href") && l[s].setAttributeNS(k, "xlink:href", n),
                              t.length &&
                                  (!0 !== (c = _[t]) && setTimeout(g({ useEl: l[s], base: t, hash: i }), 0),
                                  void 0 === c &&
                                      ((h = t),
                                      (p = u = d = void 0),
                                      window.XMLHttpRequest && ((d = new XMLHttpRequest()), (u = y(location)), (p = y(h)), (d = void 0 === d.withCredentials && "" !== p && p !== u ? XDomainRequest || void 0 : XMLHttpRequest)),
                                      void 0 !== (a = d) && ((c = new a()), ((_[t] = c).onload = v(c)), (c.onerror = b(c)), (c.ontimeout = b(c)), c.open("GET", t), c.send(), (f += 1)))))
                            : o
                            ? t.length && _[t] && setTimeout(g({ useEl: l[s], base: t, hash: i }), 0)
                            : void 0 === _[t]
                            ? (_[t] = !0)
        ...
        p.fn.circularloader = function (t) {
            ...
            if (0 == p("#" + i + "canvas").length) {
                var n = p.extend(
                    ...
                    s = parseInt(n.radius),
                    o = parseInt(n.progressBarWidth),
                    a = parseInt(0 < parseInt(n.progressValue) ? n.progressValue : n.progressPercent),
                    r = parseInt(n.progressPercent),
                    l =
                        "color:" +
                        n.fontColor +
                        ";font-size:" +
                ...
                p(
                    ...
                    p('<input class="clProg" style="' + l + '" value="' + a + (null == t.progressValue ? "%" : "") + '" aria-hidden="true"></input>').appendTo(e),
                    "" == n.title
                        ? p("#" + i).css("height", 2 * (s + o))
                        : (p("#" + i).css("height", 2 * (s + o) + 20),
                          p("#" + i + "canvas").before("<div class='titleCircularLoader' style='height:19px;text-align:center;'>" + n.title + "</div>"),
                          p(".titleCircularLoader").css("width", 2 * (s + o)));
                var c = p("#" + i + "canvas")[0],
                    h = c.getContext("2d"),
                    d = c.width / 2,
                    u = c.height / 2;
                p("#" + i + "canvas").offset().left,
                    p("#" + i + "canvas").offset().top,
                    h.beginPath(),
                    h.arc(d, u, s, 0, 2 * Math.PI, !1),
                    ...
                    h.closePath(),
                    0 < r && f(r, a, i);
            } else if (null != t.progressPercent || null != t.progressValue) {
                (r = 0), (a = 0);
                (r = null == t.progressPercent ? (100 < parseInt(t.progressValue) ? 100 : parseInt(t.progressValue)) : 100 < parseInt(t.progressPercent) ? 100 : parseInt(t.progressPercent)),
                    (a = null == t.progressValue ? (100 < parseInt(t.progressPercent) ? 100 : parseInt(t.progressPercent)) : parseInt(t.progressValue)),
                    f(r, a, i);
            }
            return this;
        };
    ...
    (function (c) {
        ...
        function t(o, a) {
            ...
            return (
                ...
                function () {
                    var n = a.showText,
                        t = c("<div>").addClass("password-meter progress rounded-0 position-absolute");
                    t.append(
                        '<div class="row position-absolute w-100 m-0">\n        <div class="col-3 border-left border-right border-white"></div>\n        <div class="col-3 border-left border-right border-white"></div>\n        <div class="col-3 border-left border-right border-white"></div>\n        <div class="col-3 border-left border-right border-white"></div>\n      </div>'
                    );
                    var s = c("<div>").attr({ class: "progress-bar", role: "progressbar", "aria-valuenow": "0", "aria-valuemin": "0", "aria-valuemax": "100" }),
                        e = c("<div>").attr({ class: "password-strength-meter" }).append(t.append(s));
                    return (
                        a.showText && ((n = c("<small>").addClass("form-text text-muted").html(a.enterPass)), e.prepend(n)),
                        o.after(e),
                        o.keyup(function () {
                            var t = (function (t) {
                                var e = 0;
                                if (0 === t.trim().length) return -2;
                                if (t.length < a.minimumLength) return -1;
                                (e += 4 * t.length), (e += l(1, t).length - t.length), (e += l(2, t).length - t.length), (e += l(3, t).length - t.length), (e += l(4, t).length - t.length), t.match(/(.*[0-9].*[0-9].*[0-9])/) && (e += 5);
                                var i = ".*[!,@,#,$,%,^,&,*,?,_,~]";
                                return (
                                    (i = new RegExp("(" + i + i + ")")),
                                    t.match(i) && (e += 5),
                            ...
                            if (
                                ...
                                s.addClass("bg-" + r(t)),
                                s.css({ width: e + "%" }),
                                s.attr("aria-valuenow", e),
                                a.showText)
                            ) {
                                var i = (function (t) {
                                    return -1 === t ? a.shortPass : (t = t < 0 ? 0 : t) < 26 ? a.shortPass : t < 51 ? a.badPass : t < 76 ? a.goodPass : a.strongPass;
                                })(t);
                                !o.val().length && t <= 0 && (i = a.enterPass),
                                    n.html() !== c("<div>").html(i).html() &&
                                        (n.html(i),
                                        n.removeClass(function (t, e) {
                                            return (e.match(/(^|\s)text-\S+/g) || []).join(" ");
                                        }),
                                        n.addClass("text-" + r(t)),
                                        o.trigger("password.text", [i, t]));
                            }
                        }),
                        this
                    );
        ...
        c.fn.password = function () {
            return this.each(function () {
                new t(c(this), c(this).data());
            });
        };
    })(jQuery),
    $(function () {
    ...
    (function (t) {
        ...
        function o(t, e) {
            ...
            (this.$target = b(t)),
                ...
                b.each(this.options.datesDisabled, function (t, e) {
                    if ("string" == typeof e) {
                        var i = n.parseDate(e);
                        n.options.datesDisabled[t] = null === i ? null : n.format(i);
                    } else e instanceof Date && !isNaN(e.valueOf()) ? (n.options.datesDisabled[t] = n.format(e)) : (n.options.datesDisabled[t] = null);
                }),
            ...
            var i = r.join("");
            (i = i.replace(/CALENDARID/g, this.id + "")),
            ...
            var s = a.join("");
            (s = s.replace(/CALENDARID/g, this.id + "")),
                (this.$button = b(s)),
        ...
        (o.VERSION = "2.1.10"),
            ...
            (o.prototype.populateDaysCalendar = function () {
                ...
                var d = this.options.isYearDisabled && this.options.isYearDisabled(this.year),
                    u = this.options.isMonthDisabled && this.options.isMonthDisabled(this.year, this.month + 1);
                for (a = 1; a <= i; a++) {
            ...
            (o.prototype.populateMonthsCalendar = function () {
                ...
                var n = '\t<tr id="row0-' + this.id + '" role="row">\n',
                    s = this.options.isYearDisabled && this.options.isYearDisabled(this.year);
                for (t = 0; t < 12; t++)
                    s
            ...
            (o.prototype.populateYearsCalendar = function () {
                ...
                for (var s = '\t<tr id="row0-' + this.id + '" role="row">\n', o = t; o <= e; o++) {
                    o == this.year
                        ...
                        : null != this.options.min && o < this.options.min.getFullYear()
                        ? (s += '\t\t<td id="cell' + (o - t + 1) + "-" + this.id + '" class="year unselectable"')
                        : null != this.options.max && o > this.options.max.getFullYear()
                        ? (s += '\t\t<td id="cell' + (o - t + 1) + "-" + this.id + '" class="year unselectable"')
            ...
            (o.prototype.handleGridKeyDown = function (t) {
                ...
                switch (t.keyCode) {
                    ...
                    case this.keys.pageup:
                        ...
                        if (l)
                            if (b("#" + r).attr("id") == d) {
                                var c = (i = this.$grid.find("td.selectable")).eq(i.length - 1);
                                this.$grid.attr("aria-activedescendant", c.attr("id")), this.selectGridCell(c.attr("id"));
                            } else this.selectGridCell(r);
                        return t.stopPropagation(), !1;
                    case this.keys.pagedown:
                        ...
                        if (l)
                            if (b("#" + r).attr("id") == d) {
                                c = (i = this.$grid.find("td.selectable")).eq(i.length - 1);
                                this.$grid.attr("aria-activedescendant", c.attr("id")), this.selectGridCell(c.attr("id"));
                            } else this.selectGridCell(r);
                        return t.stopPropagation(), !1;
                    case this.keys.home:
            ...
            (o.prototype.handleGridFocus = function (t) {
                var e = this.$grid.attr("aria-activedescendant");
                if (b("#" + e).attr("id") == d) {
                    var i = this.$grid.find("td.selectable"),
                        n = i.eq(i.length - 1);
                    this.$grid.attr("aria-activedescendant", n.attr("id")), this.selectGridCell(n.attr("id"));
                } else this.selectGridCell(e);
                return !0;
            }),
            ...
            (o.prototype.changeGrid = function (t) {
                switch (this.gridType) {
                    ...
                    case 1:
                        if ((this.populateYearsCalendar(), this.year != this.curYear)) {
                            e = this.$grid.find("td.selectable");
                            this.$grid.attr("aria-activedescendant", e.eq(0).attr("id"));
                        } else this.$grid.attr("aria-activedescendant", this.$grid.find(".curYear").attr("id"));
                        this.selectGridCell(this.$grid.attr("aria-activedescendant"));
                }
                return !0;
            }),
            ...
            (o.prototype.updateLinked = function (t) {
                if (null !== this.options.previous && "" !== this.options.previous.val() && t < this.options.previous.datepicker("getDate")) {
            ...
            (o.prototype.show = function () {
                var i = this;
                if ((b(".datepicker-calendar").trigger("ab.datepicker.opening", [i.id]), 1 == this.options.modal)) {
                    this.modalEventHandler ||
                        ...
                        this.greyOut(!0);
                    var t = parseInt(b("#datepicker-overlay").css("z-index"), 10) || 40;
            ...
            (o.prototype.absolutePosition = function (t) {
                ...
                if (t.getBoundingClientRect) {
                    ...
                    (e = Math.round(n.top + a - l)), (i = Math.round(n.left + r - c));
            ...
            (o.prototype.createDateFromFormat = function (t, a) {
                ...
                if ((2 == h.length && (h = 50 < h ? h - 0 + 1900 : h - 0 + 2e3), d < 1 || 12 < d)) return null;
                if (2 == d)
                    if ((h % 4 == 0 && h % 100 != 0) || h % 400 == 0) {
                        if (29 < u) return null;
                    } else if (28 < u) return null;
                return (4 == d || 6 == d || 9 == d || 11 == d) && 30 < u ? null : (p < 12 && "PM" == g ? (p = p - 0 + 12) : 11 < p && "AM" == g && (p -= 12), new Date(h, d - 1, u, p, f, m));
            }),
            ...
            (o.prototype.daysOfWeekDisabled = function (t) {
                if (null != t) {
                    (this.options.daysOfWeekDisabled = []), b.isArray(t) || (t = [t]);
                    var i = this;
            ...
            (o.prototype.modal = function (t) {
                if (null != t)
                    if (((this.options.modal = t), 1 == this.options.modal)) {
            ...
            (o.prototype.datesDisabled = function (t) {
                ...
                b.each(t, function (t, e) {
                    if ("string" == typeof e) {
                        var i = n.parseDate(e);
                        null !== i && n.options.datesDisabled.push(n.format(i));
                    } else e instanceof Date && !isNaN(e.valueOf()) && n.options.datesDisabled.push(n.format(e));
                });
            }),
    ...
    (function () {
        var p = document.querySelector(".it-header-sticky");
        if (p) {
            var t = (function (t) {
                    var e = !1;
                    if (t) {
            ...
            !(function (e) {
                ...
                function o(t, e, i) {
                    if ((void 0 === e && (e = !0), t)) {
                        var n = document.querySelector(".menu-wrapper");
                        if (e) {
                            var s = document.querySelector(".it-brand-wrapper"),
                            ...
                            r && n.insertBefore(r, n.childNodes[0]).classList.add("cloned"), l && n.appendChild(l).classList.add("cloned"), c && n.appendChild(c).classList.add("cloned").remove("show");
                        } else {
                            var h = document.getElementsByClassName("cloned");
                            h &&
                    ...
                    p.nextElementSibling.style.paddingTop = e ? d + (t ? u - f : d - f) + "px" : "0px";
                }
                (r = function () {
                    var t = d;
                    window.scrollY + f >= u && !a ? ((a = !0), p.classList.add("is-sticky"), o(e, !0), t !== d && (f = d - t)) : window.scrollY + f < u && a && ((a = !1), p.classList.remove("is-sticky"), o(e, !1));
                }),
    ...
    (function () {
        var e = document.getElementsByClassName("sticky-wrapper"),
...
var styleNode = document.createElement("style"),
    __PUBLIC_PATH__ = window.__PUBLIC_PATH__ ? window.__PUBLIC_PATH__ : "/fonts";
(styleNode.innerHTML =
                            ...
                            if ((h.empty(), e.length))
                                for (var i in d) {
                                    var n = new RegExp("(" + e + ")", "gi"),
                                        s = d[i].text.replace(n, "<mark>$1</mark>"),
                                        o = d[i].label ? "<em>" + d[i].label + "</em>" : "",
                                        a = d[i].icon ? d[i].icon : "",
                                        r = d[i].link ? d[i].link : "#";
                                    if (-1 !== s.toLowerCase().indexOf(e.toLowerCase())) {
            ...
            u = (function () {
                ...
                return (
                    ...
                    (n._getCookieEU = function () {
                        ...
                        for (t = 0; t < n.length; t++) if (((e = n[t].substr(0, n[t].indexOf("="))), (i = n[t].substr(n[t].indexOf("=") + 1)), (e = e.replace(/^\s+|\s+$/g, "")) == a)) return unescape(i);
                    }),
                    _createClass2(n, null, [
                        {
                            key: "VERSION",
...
function notificationShow(t, e) {
    if (($("#" + t).fadeIn(300), !$("#" + t).hasClass("dismissable"))) {
        if (($("#" + t).fadeIn(300), "number" == typeof e)) var i = e;
        else i = 7e3;
        setTimeout(function () {
            $("#" + t).fadeOut(100);
        }, i);
...
$(function () {
    ...
    $(function () {
        function o(t) {
            var e = t.siblings("label:not(.active)");
            if (e && e.length) {
                var i = e[0].offsetWidth > t[0].offsetWidth - 20 ? t[0].offsetWidth : "auto";
                $(e[0]).css("width", i);
            }
        }
            ...
            a = function (t) {
                if (t.hasClass("validate")) {
                    ...
                    if (i && n) t.removeClass("valid").removeClass("invalid");
                        ...
                        s && (!o || o > e.length) ? t.removeClass("invalid").addClass("valid") : t.removeClass("valid").addClass("invalid");
                    }
                }
            };
        $(window).resize(function () {
                ...
                .on("scroll", function () {
                    ...
                    $(".it-page-section").each(function (t) {
                        if ($(this).position().top <= a) {
                            $(".it-navscroll-wrapper .menu-wrapper a.active").removeClass("active"), $(".it-navscroll-wrapper .menu-wrapper a").eq(t).addClass("active");
                            var e = $(".it-navscroll-wrapper .menu-wrapper a").eq(t).closest("ul").prev("a"),
                                i = $(e).closest("ul").prev("a");
                            $(e).addClass("active"), $(i).addClass("active");
                            var n = $(".it-navscroll-wrapper .menu-wrapper a").eq(t).find("span").text(),
                                s = $(".it-navscroll-wrapper .custom-navbar-toggler"),
                                o = s.find("span.it-list");
                            s.text(n), s.prepend(o);
                        }
                    });
                })
                .scroll();
...
$(document).ready(function () {
    ...
    function E(t, e) {
        var i = t.val();
        if (i) {
            var n = t.siblings("label");
            ("" != i ? i.match(timeRegEx) : "") ? n.removeClass("error-label").html(k[e]) : n.addClass("error-label").html("Formato ora non valido (hh:mm)");
        }
    }
    $(".it-timepicker-wrapper").each(function (s) {
        ...
        function o(t, e) {
            switch (
                ((function (t) {
                    (h = t.closest(".spinner").find("input")), (a = parseInt(h.attr("aria-valuemin"))), (r = parseInt(h.attr("aria-valuemax"))), (l = parseInt(h.attr("aria-valuenow"))), (c = parseInt(h.attr("bb-skip")));
                })(e),
                t)
            ) {
                case "up":
        ...
        (k[s] = p.siblings("label").text()),
            ...
            p
                .on("keyup", function (t) {
                    ...
                    if (i.includes(":")) {
                        var n = i.split(":");
                        m.attr("aria-valuenow", n[0].substring(0, 2)),
                            m.attr("value", n[0].substring(0, 2)),
                            m.val(n[0].substring(0, 2)),
                            (d = n[0].substring(0, 2)),
                            g.attr("aria-valuenow", n[1].substring(0, 2)),
                            g.attr("value", n[1].substring(0, 2)),
                            g.val(n[1].substring(0, 2)),
                            (u = n[1].substring(0, 2));
                    } else m.attr("aria-valuenow", i.substring(0, 2)), m.attr("value", i.substring(0, 2)), m.val(i.substring(0, 2)), (d = i.substring(0, 2));
                    if (13 === e) return E(p, s);
                })
                .on("focus", function (t) {
                    t.stopPropagation(), p.val() && E(p, s);
                })
                .on("blur", function (t) {
                    p.val() && E(p, s);
                }),
    ...
    $(function () {
        ...
        $(".input-number input[type=number]").each(function (t) {
            ...
            $(".input-number button").click(function (t) {
                t.preventDefault();
                var e = $(this).closest(".input-number").find("input[type=number]"),
                    i = parseFloat(e.val());
                if (!isNaN(i)) {
                    var n = 0,
                        s = parseFloat(e.attr("max")),
                        o = parseFloat(e.attr("min")),
                        a = parseFloat(e.attr("step"));
                    (a = a || 1), $(this).hasClass("input-number-add") && ((n = !isNaN(s) && s <= i + a ? s : i + a), e.val(n)), $(this).hasClass("input-number-sub") && ((n = !isNaN(o) && i - a <= o ? o : i - a), e.val(n));
                }
                r(e);
            }),
    ...
    $(function () {
        ...
        $(P).each(function () {
            $(this).closest(".it-carousel-wrapper").hasClass("it-carousel-landscape-abstract-three-cols") &&
                ...
                (S = 3),
                (O = L = T = I = 0),
                $(this).hasClass("it-card-bg") && ((w = g = 40), (L = I = 12), (O = T = C = v = 24)),
                $(this).hasClass("it-img-card") && ((w = g = 40), (L = I = 0), (O = T = C = v = 24)),
                $(this).hasClass("it-img-card") && $(this).hasClass("it-big-img") && ((e = !0), (v = g = 0), (w = 160), (C = 24), (L = I = 320), (O = T = 48), (S = x = _ = 1)),
                $(this).hasClass("it-img-card") && $(this).hasClass("it-standard-image") && ((e = !0), (g = 40), (m = 1), (_ = 2), (I = 68), (L = w = 48), (O = T = C = v = 24), (S = x = 3))),
                $(this).closest(".it-carousel-wrapper").hasClass("it-calendar-wrapper") &&
                    ...
                    (S = 4),
                    (O = L = T = I = C = v = 0),
                    $(this).hasClass("it-card-bg") && ((w = g = 40), (O = L = T = I = C = v = 0)),
                    $(this).hasClass("it-img-card") && ((w = g = 40), (O = L = T = I = C = v = 0)),
                    $(this).hasClass("it-img-card") && $(this).hasClass("it-big-img") && ((e = !0), (w = 160), (L = I = 320), (O = T = C = v = g = 0), (S = x = _ = 1)),
                    $(this).hasClass("it-img-card") && $(this).hasClass("it-standard-image") && ((e = !0), (g = 40), (m = 1), (C = _ = 2), (I = 68), (L = w = 48), (O = T = v = 0), (S = x = 4))),
                ...
                $(this).owlCarousel &&
                    $(this).owlCarousel({
                        ...
                        responsive: {
                            ...
                            992: { nav: k, dots: E, items: x, stagePadding: I, margin: T },
                            1200: { nav: D, dots: A, stagePadding: L, items: S, margin: O },
                        },
    ...
    $(function () {
        ...
        $(r).each(function (t) {
            ...
            $(t).on("click", function () {
                !(function (t) {
                    var e = $(t).find(".transfer-group input"),
                        i = $(t).find(".transfer-group input:checked"),
                        n = $(t).find(".transfer-header input");
                    (s = t.closest(".it-transfer-block").find("a.transfer")),
                        (o = t.closest(".it-transfer-block").find("a.backtransfer")),
                        0 < i.length ? ($(e).prop("checked", !1), $(n).removeClass("semi-checked").prop("checked", !1), t.hasClass("source") ? a(s) : a(o)) : ($(e).prop("checked", !0), t.hasClass("source") ? d(s) : d(o));
            ...
            $(e).on("click", function () {
                !(function (t) {
                    ...
                    (s = t.closest(".it-transfer-block").find("a.transfer")),
                        (o = t.closest(".it-transfer-block").find("a.backtransfer")),
                        0 == i.length
                            ? (n.removeClass("semi-checked").prop("checked", !1), t.hasClass("source") ? a(s) : a(o))
                            : (i.length == e.length ? n.removeClass("semi-checked").prop("checked", !0) : n.addClass("semi-checked").prop("checked", !1), t.hasClass("source") ? d(s) : d(o));
                })($(this).closest(".it-transfer-wrapper"));
            }),
            $(s).on("click", function (t) {
                var e = $(this).closest(".it-transfer-block").find(".source"),
                    i = $(this).closest(".it-transfer-block").find(".target");
                d((n = $(this).closest(".it-transfer-block").find("a.reset"))), a($(this)), u(e, i), t.preventDefault();
            }),
            $(o).on("click", function (t) {
                var e = $(this).closest(".it-transfer-block").find(".source"),
                    i = $(this).closest(".it-transfer-block").find(".target");
                d((n = $(this).closest(".it-transfer-block").find("a.reset"))), a($(this)), u(i, e), t.preventDefault();
            }),
            $(n).on("click", function (t) {
                var e = $(this).closest(".it-transfer-block"),
                    i = e.find("a.transfer"),
                    n = e.find("a.backtransfer");
                a(i),
                    a(n),
                    a($(this)),
                    (function (t) {
                        var e = t.find(".source .transfer-group"),
                            i = t.find(".target .transfer-group"),
                            n = t.find(".source .transfer-header span.num"),
                            s = t.find(".target .transfer-header span.num"),
                            o = t.find(".transfer-header input"),
                            a = t.find(".transfer-group input");
                        $(e).find(".form-check").detach(),
                            $(i).find(".form-check").detach(),
                            $(e).append(r),
                            $(i).append(l),
                            $(n).text(c),
                            $(s).text(h),
                            $(o).prop("disabled", !1).removeClass("semi-checked"),
                            $(o).prop("checked", !1),
                            $(a).prop("checked", !1);
                    })(e),
                    t.preventDefault();
